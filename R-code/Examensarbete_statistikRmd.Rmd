...
ord.output <- polr(scale_1_5 ~ guidance + guidance2 + inf_steps + xtra_prompt + atumn,
                   data = df_tot)
...
# Kan funka med dummies för den kategorin som är störst
# confmx <- table(round(ord.output$fitted.values), df_tot$scale_1_5)
```
...
# För plots vid prediktion: https://www.r-bloggers.com/2019/06/how-to-perform-ordinal-logistic-regression-in-r/ 

hist(df_tot$scale_1_5)
```
